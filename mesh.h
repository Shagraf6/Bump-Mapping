...
{
	static Point3 Points[8];          //  Vertices
	//	static Vector3 Vectors[7];        //  Normals
	static VertexID VertexIDs[8][4];  // Indices

	static Face FaceLists[6];         //     
	Points[0].set(-1.3, -1.7, -1.3);
	Points[1].set(-1.3, -1.7, 1.3);
	Points[2].set(-1.3, 1.7, -1.3);
	Points[3].set(-1.3, 1.7, 1.3);
	Points[4].set(1.3, -1.7, -1.3);
	Points[5].set(1.3, -1.7, 1.3);
	Points[6].set(1.3, 1.7, -1.3);
	Points[7].set(1.3, 1.7, 1.3);

	VertexIDs[0][0] = VertexID(3, 0);
	VertexIDs[0][1] = VertexID(7, 0);
	VertexIDs[0][2] = VertexID(6, 0);
	VertexIDs[0][3] = VertexID(2, 0);

	VertexIDs[1][0] = VertexID(0, 1);
	VertexIDs[1][1] = VertexID(1, 1);
	VertexIDs[1][2] = VertexID(5, 1);
	VertexIDs[1][3] = VertexID(4, 1);

	// Vertex ID and Normal Vector ID  for Face 2
	VertexIDs[2][0] = VertexID(2, 2);
	VertexIDs[2][1] = VertexID(6, 2);
	VertexIDs[2][2] = VertexID(4, 2);
	VertexIDs[2][3] = VertexID(0, 2);

	// Vertex ID and Normal Vector ID  for Face 3
	VertexIDs[3][0] = VertexID(1, 3);
	VertexIDs[3][1] = VertexID(3, 3);
	VertexIDs[3][2] = VertexID(7, 3);
	VertexIDs[3][3] = VertexID(5, 3);

	VertexIDs[4][0] = VertexID(2, 4);
	VertexIDs[4][1] = VertexID(0, 4);
	VertexIDs[4][2] = VertexID(1, 4);
	VertexIDs[4][3] = VertexID(3, 4);

	VertexIDs[5][0] = VertexID(4, 5);
	VertexIDs[5][1] = VertexID(6, 5);
	VertexIDs[5][2] = VertexID(7, 5);
	VertexIDs[5][3] = VertexID(5, 5);
	...
	FaceLists[5] = Face(4, VertexIDs[5]);
	//FaceLists[6] = Face(4, VertexIDs[6]);
	//FaceLists[7] = Face(4, VertexIDs[7]);
...
void Mesh::InitializeTetrahedron()
{
	...
	static VertexID VertexIDs2[2][5];  // Indices
	...
	Vectors[0].set(-1, 0, 0);
	Vectors[1].set(-0.707107, -0.707107, 0);
	Vectors[2].set(0.707107, 0.707107, 0);
	Vectors[3].set(1, 0, 0);
	Vectors[4].set(0, -1, 0);
	Vectors[5].set(0, 0, 1);
	Vectors[6].set(0, 0, -1);
